...
export const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-colors ' +
    ...
    'disabled:pointer-events-none disabled:opacity-60 dark:focus-visible:ring-offset-gray-900',
  {
    variants: {
      variant: {
        primary: 'bg-primary text-white hover:bg-primary-dark',
        secondary: 'bg-brand text-white hover:bg-brand/90',
        outline: 'border border-primary text-primary hover:bg-primary hover:text-white dark:border-primary/60 dark:text-primary dark:hover:bg-primary dark:hover:text-white',
