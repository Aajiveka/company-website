...
export const employerRouteTree: RouteObject = {
  ...
  children: [
    ...
    { path: '/company/jobs', element: <JobListPage /> },
    { path: '/company/jobs/drafts', element: <JobListPage /> },
    { path: '/company/jobs/archived', element: <JobListPage /> },
    { path: '/company/post-job', element: <AddJobPage /> },
    { path: '/company/jobs/:id/edit', element: <AddJobPage /> },
